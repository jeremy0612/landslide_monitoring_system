...
class SparkSubmitOperator(BashOperator):
   ...
   """
    ...
    def __init__(
        ...
        super(SparkSubmitOperator, self).__init__(bash_command=self.bash_command,  env=env, output_encoding=output_encoding, *args, **kwargs)
    ...
    def execute(self, context):
        ...
        if self.is_not_null_and_is_not_empty_str(self.jars):
            self.bash_command += "--jars " + self.jars + " "
